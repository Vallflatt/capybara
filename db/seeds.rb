...
tondeuse_honda = Article.new(
  ...
  description: "Date de 2005, bon fonctionnement mais usée HRG415C2 SDE",
  street: 'Avenue de la Rochelle 5',
  city: 'Prilly',
  zipcode: 1009,
  available: true,
...
scie_circul_robin.photo.attach(io:file, filename: 'scie-circul-robin.jpg', content_type: "image/jpg")
scie_circul_robin.save
...
tondeuse_tracteur_robin.photo.attach(io:file, filename: 'tondeuse-robin.jpg', content_type: "image/jpg")
tondeuse_tracteur_robin.save

file = URI.open("https://can01.anibis.ch/Nettoyeurs-a-haute-pression-Karcher/?512x384/3/60/anibis/058/244/047/aorO2upnQEGTbJdegnWrrQ_1.jpg")
karcher_robin = Article.new(
  name: "Kärcher à haute pression",
  description: "Nettoyeur à haute pression avec eau chaude qui fonctionne toujours bien",
  street: "Chemin du Fau-Blanc 15",
  city: "Pully",
  zipcode: 1009,
  available: true,
...
karcher_robin.photo.attach(io:file, filename: 'tondeuse-robin.jpg', content_type: "image/jpg")
karcher_robin.save
...
Booking.create!(
  ...
  status: :confirmed,
  user: faus_teen,
  article: tondeuse_tracteur_robin,
  message: "C'est tout bon, passe le matin chez moi"
)
...
Booking.create!(
  ...
  status: :declined,
  user: lbevo,
  article: karcher_robin,
  message: "Désolé, je vais en avoir besoin ce jour-là"
)
